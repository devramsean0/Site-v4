            ...
            {guestlogs().map((guestlog: any) => (
                <div class="bg-gray-100 p-5 rounded-md">
                    <div class="flex gap-5 items-center">
                        <img src={guestlog.gravatar_url ? `${guestlog.gravatar_url}?s=80&d=${encodeURI(BlankAvatar.src)}` : BlankAvatar.src} alt={guestlog.gravatar_url ? guestlog.name : "Placeholder User Avatar"} class="rounded-full w-20 h-20" loading="lazy"/>
